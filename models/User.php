...
interface UserDAOInterface {
    ...
    public function create(User $user, $authUser = false); #irá criar o usuario e já fez login
    ...
    public function authenticatorUser($email, $password); #junto com setTokenSession irá efetuar o login
