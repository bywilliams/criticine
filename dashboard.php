...
<div id="main-container" class="container-fluid">
    ...
    <p class="secttion-desciption">Adicione ou atualize as informações dos filmes que você enviou.</p>
    <div class="col-md-12" id="add-movies-container">
        <a href="<?= $BASE ?>newmovie.php" class="btn card-btn">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions-column">
                        ...
                        <form action="<?= $BASE_URL ?>movie_process.php" method="GET">
